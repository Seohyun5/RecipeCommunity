      ...
      <div class="row justify-content-center">
        <div class="col-lg-10">
          ...
          <div class="blog-post-meta">
            <div class="column"><span>by&nbsp;</span>${blog.nickname }</div>
            <div class="column"><span><i class="material-icons date_range"></i>&nbsp;${blog.date }</span></div>
          </div>
          <!-- Post Content -->
          <h2 class="margin-top-2x">${blog.subject }</h2>
          <p>${blog.content }</p>
          <div class="col-12 text-right">
          <button href="updateBjsp.do?blogno=${blog.blogno }" class="btn btn-primary" type="submit">수정</button>
          <button href="deleteBlog.do?blogno=${blog.blogno }" class="btn btn-primary" type="submit">삭제</button>
          </div>
          <!-- Post Tags + Share-->

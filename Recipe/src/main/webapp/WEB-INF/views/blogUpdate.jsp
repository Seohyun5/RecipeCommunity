...
<html lang="en">
  ...
  <body>
    ...
    <!-- Write Form-->
      ...
      <form action="updateBlog.do" class="row" method="post">
        <div class="col-sm-12">
          <div class="form-group">
            <label for="comment-name">제목</label>
            <input class="form-control" type="text" id="blogtitle" placeholder=${blog.subject } name="subject" required>
          </div>
        </div>
        <div class="col-12">
          <div class="form-group">
            <label for="comment-text">내용</label>
            <textarea class="form-control" rows="17" id="blogcontent" placeholder=${blog.content } name="content" required></textarea>
          </div>
        </div>
        <div class="col-sm-12">
          <div class="form-group">

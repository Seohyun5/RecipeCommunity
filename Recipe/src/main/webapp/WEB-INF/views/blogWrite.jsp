      ...
      <form action="insertBlog.do" class="row" method="post" enctype="multipart/form-data">
        <div class="col-sm-12">
          <div class="form-group">
            ...
            <input class="form-control" type="text" id="blogtitle" placeholder="제목을 입력하세요" name="subject" required>
          </div>
        </div>
        <div class="col-12">
          <div class="form-group">
            <label for="comment-text">내용</label>
            <textarea class="form-control" rows="17" id="blogcontent" placeholder="내용을 입력하세요" name="content" required></textarea>
          </div>
        </div>
        <div class="col-sm-12">
          <div class="form-group">

...
<html lang="en">
  ...
  <body>
    ...
    <header class="navbar navbar-sticky">
      ...
      <nav class="site-menu">
        <ul>
          ...
          <li class="active"><a href="like.do"><span>Mypage</span></a>
            <ul class="sub-menu">
    ...
    <div class="page-title">
      <div class="container">
        ...
        <ul class="breadcrumbs">
          <li><a href="getMyrecipeList.do">My Recipe</a>
          </li>
    ...
    <div class="container padding-bottom-2x mb-4">
      <!-- Post-->
      <c:forEach var="item" items="${myblogList}">
      <article class="row mt-5 mb-4">
        <div class="media mb-4"><img class="d-flex align-self-start mr-4" src="../img/components/img13.jpg" width="128" alt="Media">
          <div class="media-body"><a href="getBlog.do?blogno=${item.blogno }">
            <h6 class="mt-0 mb-1">${item.subject }</h6>
            <span class="d-block text-sm text-muted">작성자 : ${item.written }</span>
            <span class="d-block text-sm text-muted">${item.content }</span>
            <span class="d-block text-sm text-muted">작성일 : ${item.date }</span>
          </a></div>
        </div>
      </article>
      </c:forEach>
